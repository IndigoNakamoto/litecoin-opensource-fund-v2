        ...
        <div ref={dropdownRef} className="flex w-full flex-col gap-4 pt-5">
            ...
            <div className="relative flex w-full space-y-3">
                <input
                    ...
                    className={`flex w-full rounded-xl border-[#222222] text-center ${!['Bitcoin', 'Litecoin', 'Dogecoin'].includes(
                        selectedCurrencyName || ''
                    )
                    ...
                    >
                        {filteredOptions.map((option, index) => (
                            <button
                                ...
                                className={`flex w-full cursor-pointer items-center p-2 text-left hover:bg-[#333333] ${highlightedIndex === index ? 'bg-gray-300' : ''
                                    }`}
                            >
                                <Image
